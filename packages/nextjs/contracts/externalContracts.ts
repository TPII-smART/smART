...
const externalContracts = {
      ...
      abi: [
        { inputs: [], stateMutability: "nonpayable", type: "constructor" },
        {
          ...
          inputs: [
            ...
            { indexed: true, internalType: "bytes32", name: "answer_hash", type: "bytes32" },
        ...
        {
          anonymous: false,
          inputs: [{ indexed: true, internalType: "bytes32", name: "question_id", type: "bytes32" }],
        ...
        },
        {
          ...
          inputs: [
            { indexed: true, internalType: "bytes32", name: "question_id", type: "bytes32" },
            { indexed: false, internalType: "uint256", name: "bounty_added", type: "uint256" },
        ...
        },
        {
          ...
          inputs: [
            { indexed: true, internalType: "bytes32", name: "question_id", type: "bytes32" },
            { indexed: false, internalType: "uint256", name: "min_bond", type: "uint256" },
          ],
          name: "LogMinimumBond",
          type: "event",
        },
        ...
        },
        {
          ...
          inputs: [
            { indexed: true, internalType: "bytes32", name: "question_id", type: "bytes32" },
            { indexed: true, internalType: "bytes32", name: "reopened_question_id", type: "bytes32" },
          ],
        ...
        },
        {
          inputs: [
            ...
            { internalType: "bytes32", name: "last_answer_or_commitment_id", type: "bytes32" },
  ...
  11155111: {
    RealityETH: {
      address: "0xB7982f20CC159a40eba4b0eA86fd6cbA6Ff810e1", // Sepolia address for Reality.eth 3.2
      abi: [
        { inputs: [], stateMutability: "nonpayable", type: "constructor" },
        {
          anonymous: false,
    ...
    KlerosArbitrator: {
      address: "0x0eb5d6cee5a679235f12e1a048a6ff4583be7be2",
      abi: [
        {
          constant: false,
          inputs: [
            { name: "_disputeID", type: "uint256" },
            { name: "_appealCost", type: "uint256" },
          ],
        ...
        },
        {
          ...
          outputs: [
            ...
            { name: "appealCost", type: "uint256" },
            { name: "appealPeriodStart", type: "uint256" },
            { name: "appealPeriodEnd", type: "uint256" },
          ],
          payable: false,
          stateMutability: "view",
          type: "function",
        },
        {
          ...
          inputs: [
            ...
            { name: "_appealCost", type: "uint256" },
            { name: "_timeToAppeal", type: "uint256" },
          ],
        ...
        {
          constant: false,
          inputs: [{ name: "_arbitrationPrice", type: "uint256" }],
