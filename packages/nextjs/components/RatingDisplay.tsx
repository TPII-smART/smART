...
export default function RatingDisplay({ ratingData }: RatingDisplayProps) {
  ...
  return (
    <div className="relative inline-block">
      ...
      >
        ...
        <span className="text-lg font-semibold text-[var(--color-primary-content)]">
          {ratingData.averageRating.toFixed(1)}
        </span>
        <span className="text-sm text-[var(--color-secondary-content)]">
      ...
      {/* Tooltip */}
      {showTooltip && (
        <div className="absolute bottom-full left-0 mb-2 z-50 bg-[var(--color-surface)] border border-[var(--color-border)] rounded-lg shadow-lg p-4 min-w-[300px]">
